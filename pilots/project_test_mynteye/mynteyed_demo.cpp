/**
 * @brief Example of a Program using the MYNT-EYE-D-SDK
 * @link https://github.com/slightech/MYNT-EYE-D-SDK/blob/develop/platforms/projects/cmake/mynteyed_demo.cc
 */
